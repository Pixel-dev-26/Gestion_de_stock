...
const stocksSrc = path.join(root, '../dist/instock-dashboard', 'stocks.html');
const stocksDest = path.join(root, '../dist', 'stocks.html');
...
copyFile(stocksSrc, stocksDest, 'stocks.html -> ../dist/stocks.html');
